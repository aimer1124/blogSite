...
categories:
  - 测试
date: 2016-05-22T11:03:00+08:00
slug: "如此Tricky的测试场景,你应该怎么办"
draft: false
---
# 什么是Tricky的测试场景？

![Tricky的测试场景](TestScenario-Tricky.png)
...
![隐藏在深处的一个不定时炸弹](TestScenario-Bomb.png)
## 为什么会这样
...
![客户投诉](TestScenario-CosumerComplain.png)
## 测试`验证码`，收到客户投诉
* Scenario
...
![显示真的不一样](TestScenario-SameBody.png)
...
![时间都去哪了？](TestScenario-TimeGoWhere.png)
## PaaS平台部署后，时间出现`偏差`
* Scenario
...
![Mock不可靠](TestScenario-MockFail.png)
...
![环境真的不一样](TestScenario-TimeZone.png)
...
![定位Tricky场景](TestScenario-HowToLocator.png)
