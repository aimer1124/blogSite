...
categories:
  - 工程效能
date: 2016-08-07T14:23:00+08:00
slug: "性能测试与持续集成"
draft: false
---
## 目的
...
![Thread组配制](ThreadConfig.png)

![Http请求](HTTPConfig.png)

![Response断言](ResponseAssertion.png)

- 使用`GUI`的JMeter查看运行测试结果

![GUI JMeter测试结果](JMeterGUIResult.png)
...
![Performance plugin ](PerformancePlugin.png)
...
![Jenkins执行结果](JenkinsExecuteResult.png)
- 在`JOB`的`workspace`下会生成两个文件`jmeter.log TestPlan.jtl`

![jmeter.log TestPlan.jtl](JMeterFilesInJenkins.png)

### 配制运行报告
- 添加测试报告

![报告读取](ConfigReadReport.png)
- 查看统计结果

![统计结果](JenkinsPerformanceResult.png)
