...
categories:
  - 工程效能
date: 2016-03-03T20:45:38+08:00
slug: "Jenkins-with-SuperTest-and-Grunt"
draft: false
---
...
![](github.NodeJS_Plugin.png)
* 等待安装成功
![](github.NodeJs_Plugin_Install.png)

## Jenkins安装Grunt
为执行Grunt时，使用
![](github.Jenkins_Install_NodeJS.png)

## 配制Job

- 在Jenkins中选择[New Item]，在[Item name]中输入(GruntJob)，并选择[Freestyle project]，点击[OK]
![](github.jenkins&grunt.FirstStep.png)
- 配制build，选择[Save]
![](github.Job_Config.png)
