...
![OpenAPP](OpenAPP.png)
![AddIntelliJ](AddIntelliJ.png)
![IntelliJDone](IntelliJDone.png)

- 使用默认浏览器打开GMail

![OpenURL](OpenURL.png)
![SetGMailURL](SetGMailURL.png)


以上步骤，已完成一个基础功能的Workflow配制。
![WorkflowDone](WorkflowDone.png)

- 测试

![TestWorkflow](TestWorkflow.png)
...
![OpenIntelliJAndGMail](OpenIntelliJAndGMail.png)
...
![CreateCommandLineLauncher](CreateCommandLineLauncher.png)

- 替换Workflow中IntelliJ的启动为命令行启动

![ReplaceWithRunScript](ReplaceWithRunScript.png)
...
![FixTwoUpgrade](FixTwoUpgrade.png)
