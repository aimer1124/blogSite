...
categories:
  - 工程效能
date: 2018-08-23T14:50:00+08:00
slug: "印象笔记支持Markdown"
draft: false
---
...
![New Markdown Note](NewMarkdownNote.png)

- 会创建一个空的Markdown的笔记，默认会显示`编辑和预览`两种状态

![EmptyMarkdownNote](EmptyMarkdownNote.png)

- 此时就可以直接进行Markdown的内容编辑了，常见的Markdown标签可直接使用。如：标题、加粗、斜体等。

- 当然印象笔记的可不限于这些功能，还带了以下功能
    - 表格，如：3*5的表格
    ![Table](MarkdownTable.png)
    - 数学公式
    ![Math](MarkdownMath.png)
    - 流程图
    ![Workflow](MarkdownWorkflow.png)
    - 时序图
    ![TimeWorkflow](MarkdownTimeWorkflow.png)
    - 甘特图
    ![Gantt](MarkdownGantt.png)
